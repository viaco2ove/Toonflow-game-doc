...
温柔女声：story_gentle_female_long.wav
活泼女声：story_lively_female_long.wav
讲述者音色：story_narrator_long.wav
标准女声：story_std_female_long.wav
标准男声：story_std_male_long.wav
沉稳男声：story_steady_male_long.wav
...
# 生成的角色语音文件为：system\voice-presets\generated\{角色id}\xxx_long.wav
# 声音复刻：输入音频格式
> ⚠️ 重要：新加坡地域不支持该功能。
...
## 注意url 可以直接访问音频文件
http://tmpfiles.org/dl/32745834/prompt_voice_584b1af953fc437a_long.wav
