...
> 源文件：`src/lib/fixDB.prompts.ts` 中的常量 `_PROMPT_STORY_ORCHESTRATOR_ADVANCED`（行 1034-1282，经 `_normalize()` 处理后由 `export const PROMPT_STORY_ORCHESTRATOR_ADVANCED` 导出）
